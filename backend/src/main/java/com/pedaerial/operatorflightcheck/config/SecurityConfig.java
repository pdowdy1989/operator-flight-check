    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/pilot/**").hasRole("PILOT")
                .requestMatchers("/api/company/**").hasRole("COMPANY")
                .requestMatchers("/api/jobs/**").hasAnyRole("PILOT", "COMPANY", "CLIENT", "ADMIN")
                .requestMatchers("/api/documents/**").authenticated()
                .requestMatchers("/api/service-catalog/active").authenticated()
                .requestMatchers("/api/service-catalog/**").hasAnyRole("PILOT", "ADMIN")
                .requestMatchers("/api/job-requests/*/decide").hasAnyRole("PILOT", "ADMIN")
                .requestMatchers("/api/job-requests/all").hasAnyRole("PILOT", "ADMIN")
                .requestMatchers("/api/job-requests/**").authenticated()
